# build_viral_video2.py - builder cho pack2_ (anh moi)
...
def build(vid):
	...
	pack_dir = "output/pack2_" + vid
	out = os.path.abspath("output/Mialinhcute_gacha_" + vid + "v2.mp4")
	print("=== building", vid)
	vo = os.path.abspath("output/gacha_vo2" + vid + ".mp3")
	...
	silent = "output/v2" + vid + "silent.mp4"
...
if __name__ == "__main__":
	vid = sys.argv[1] if len(sys.argv) > 1 else "cold"
	result = build(vid)
	print("RESULT:", result)