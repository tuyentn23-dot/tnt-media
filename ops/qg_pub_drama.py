...
v = "output/Mialinhcute_v2_drama.mp4"
q = QG.evaluate(v)
...
if q.get("passes"):
 ...
 title = cfg["title"]
 desc = cfg["desc"] + chr(10) + chr(10) + "#gacha #drama #betrayal #shorts #viral #sad"
 tags = cfg["tags"]
 topic = "chMialinhcute_v2_drama_" + time.strftime("%Y%m%d_%H%M%S")
