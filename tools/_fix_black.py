...
# 1) Xoa 2 file hong
bad = [
 'output/chMialinhcute_meme_funny_dog_1_20260919_181110.mp4',
 'output/chMialinhcute_roblox_bloxfruits_20260919_123537.mp4',
]
for p in bad:
    if os.path.exists(p):
        os.remove(p)
...
# 2) Build lai meme_funny_dog_1 cho Mia
CID='Mialinhcute'
cfg=ch.load(CID)
style=cfg.get('style',{})
cf.set_channel(CID)
os_publish.set_channel(CID)
item=[it for it in ch.load_content(CID,'meme') if it['id']=='meme_funny_dog_1']
if item:
    item=item[0]
